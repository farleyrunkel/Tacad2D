...
// Purpose  :
// ================================================================
Handle(OpenGl_Context) ViewportHelper::getGlContext(const Handle(V3d_View)& theView)
{
...
Aspect_VKeyMouse ViewportHelper::qtMouseButtons2VKeys(Qt::MouseButtons theButtons)
{
...
Aspect_VKeyFlags ViewportHelper::qtMouseModifiers2VKeys(Qt::KeyboardModifiers theModifiers)
{
...
Aspect_VKey ViewportHelper::qtKey2VKey(int theKey)
{
    switch(theKey)
    {
    case 1060: // ru
